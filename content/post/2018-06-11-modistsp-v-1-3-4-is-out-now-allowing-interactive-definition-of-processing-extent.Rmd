...
We are happy to report that a new version of [MODIStsp](http://lbusett.github.io/MODIStsp/) (1.3.4) is on [CRAN](https://cran.r-project.org/web/packages/MODIStsp/index.html) as of today ! 
...
The full changelog for v1.3.4 can be found [HERE](https://github.com/lbusett/MODIStsp/releases/tag/v1.3.4)
